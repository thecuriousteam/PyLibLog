...
Python has many use cases in different industries such as
  ...
  GIS (Geographic Information System):
    - Python is used for GIS applications, and libraries like Geopandas and ArcPy are popular 
      ...
      <h3><b><u>Program 1</u>: Hello World! </b></h3>
      <br />
      <pre>
        <code> <b>
          {`print("Hello World!")`}
    ...
    <br />
      <h2>
        <b><u>To run the programs:</u></b> <br /> <br />
      </h2>
      <ol>
...
<br /><br />
      ...
      <h1><b>7. Some of the Exception Handling Techniques</b></h1>
      <br />
...
my_dog.bark()`}
      ...
      <br /> 
      <br />
      Now that you have completed your introduction to python, solve some coding questions to get familiar with the python syntax and move on to learn some python libraries which we had discussed in the introduction to python section above.
    </div>
  );
};
