    ...
    <div>
      ...
      >
        ...
        <div className="flex flex-col  h-full">
          ...
          <ul
            className="whitespace-pre  text-[16px]  flex flex-col gap-1 font-light overflow-x-hidden scrollbar-thin scrollbar-track-[#ccc] scrollbar-thumb-yellow-500 md:h-[68%] h-[70%]  "
            ...
            {(open || isTabletMid) && (
              <div className="py-5 border-slate-300 text-[16px]  ">
                ...
                {subMenusList?.map((data, i) => (
                  <div
                    key={i}
                    className="flex flex-col gap-1 text-[16px]  hover:bg-[#8800ff] hover:text-white border border-[#BFC9CA] "
                    style={{
