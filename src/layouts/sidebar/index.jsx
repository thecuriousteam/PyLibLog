    ...
    <div style={styleSidebar}>
      ...
      <motion.div
        ...
        <div className="flex flex-col  h-full">
          ...
          {open && (
            <div className="flex-1 text-sm z-50 max-h-48 my-auto whitespace-pre w-full font-medium mb-0">
              <div className="flex border-y border-slate-300 items-center justify-between">
                <div>
                  <p>PyLibLog</p>
